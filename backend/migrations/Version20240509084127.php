 ...
 */
final class Version20240509084127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reply (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, content VARCHAR(999) DEFAULT NULL, INDEX IDX_FDA8C6E0B83297E7 (reservation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reply_to_contact_request (id INT AUTO_INCREMENT NOT NULL, contact_id INT DEFAULT NULL, content VARCHAR(999) DEFAULT NULL, INDEX IDX_D8519DE4E7A1254A (contact_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, destination_id INT DEFAULT NULL, user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, departure DATETIME NOT NULL, coming_back DATETIME NOT NULL, description VARCHAR(555) NOT NULL, price INT NOT NULL, INDEX IDX_7656F53B816C6140 (destination_id), INDEX IDX_7656F53BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE reply_to_contact_request ADD CONSTRAINT FK_D8519DE4E7A1254A FOREIGN KEY (contact_id) REFERENCES contact (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reply_to_contact_request DROP FOREIGN KEY FK_D8519DE4E7A1254A');
        ...
        $this->addSql('DROP TABLE reply_to_contact_request');
